...
Next: [Composition](/docs/composition) for the patterns we enforce, and [Components](/docs/components) for end-to-end specimens. You can [download the Composition guide as Markdown](/api/docs/composition) to adapt or ship with your own project.
