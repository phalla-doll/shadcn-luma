    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Define your financial target and we&apos;ll help you pace
                    your savings.
                </CardDescription>
            </CardHeader>
            <CardContent>
...
export default function Page() {
    return (
        <DocsPage>
            <DocsTitle>New Milestone</DocsTitle>
            <DocsDescription>New milestone goal form card</DocsDescription>
            <DocsBody>
                <CodeViewer component={<NewMilestone />} code={code} />
            </DocsBody>
        </DocsPage>
    )
}
