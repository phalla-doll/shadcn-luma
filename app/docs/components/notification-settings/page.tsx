                ...
                <FieldGroup>
                    ...
                    {NOTIFICATIONS.map((n) => (
                        <Field key={n.id} orientation="horizontal">
                            ...
                            />
                            <FieldContent>
                                <FieldLabel htmlFor={\`notify-\${n.id}\`}>
                                    {n.label}
                                </FieldLabel>
                                <FieldDescription>
                                    {n.description}
...
export default function Page() {
    return (
        <DocsPage>
            <DocsTitle>Notification Settings</DocsTitle>
            <DocsDescription>
                Notification preferences with checkboxes
            </DocsDescription>
            <DocsBody>
                <CodeViewer component={<NotificationSettings />} code={code} />
            </DocsBody>
        </DocsPage>
    )
}
