                ...
                <FieldGroup>
                    ...
                    <Field orientation="horizontal">
                        <FieldContent>
                            ...
                            <FieldDescription>
                                Allow others to see your total stream count and
                                listening activity
                            </FieldDescription>
                        </FieldContent>
...
export default function Page() {
    return (
        <DocsPage>
            <DocsTitle>Preferences</DocsTitle>
            <DocsDescription>
                User preferences with switches and select
            </DocsDescription>
            <DocsBody>
                <CodeViewer component={<Preferences />} code={code} />
            </DocsBody>
        </DocsPage>
    )
}
